...
std::vector<uint8> LoadImageFromFile(const char* file_name, int* out_width, int* out_height,int* out_channels) {
...
std::vector<uint8> LoadImage(CGImage* image, int* out_width, int* out_height, int* out_channels) {
...
//    NSLog(@"LOOK AT ME IN THE FUCKING FACE BITCH %d %d",width, height);
